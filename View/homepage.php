...
<div class="container">
    <div class="col-12">
            ...
            <div class="collapse navbar-collapse" id="navbarSupportedContent">
                <ul class="navbar-nav mr-auto">
                    <li class="nav-item active">
                        <a class="nav-link" href="homepage.php?page=listCategories">Category<span class="sr-only">(current)</span></a>
                    </li>
                    <li class="nav-item active">
                    ...
                    <li class="nav-item active">
                        <a class="nav-link" href="homepage.php?page=logout">Logout</a>
                    </li>
                </ul>
        ...
        switch ($page) {
            case 'listCategories';
                $categoriesController->getListCategory();
                break;
            case 'createCate';
